...
parser.add_argument('--model_name', type=str, default= "rgl_sim_hallway_bottleneck_occlusion_False_rot_bound_8.75_speed_samps_3_rot_samps_10_humans_3_hmin_3_hmax_3")
parser.add_argument('--version_num', type=int, default=0)
parser.add_argument('--trained_steps', type=int, default=6000)
...
policy_config_file = os.path.join(curr_dir, f"logs/{args.model_name}_{args.version_num}/rgl_policy.config")
