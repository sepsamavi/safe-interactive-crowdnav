    ...
    hypers = {
        ...
        "state": {
            ...
            "BICYCLE": {
                ...
                "velocity": ["x", "y"],
                "acceleration": ["x", "y"],
            },  # For now use the same state representation for PEDESTRIAN. Later can add heading and etc. when it is calculated
            "JRDB_ROBOT": {
                "position": ["x", "y"],
                "velocity": ["x", "y"],
                "acceleration": ["x", "y"],
            },  # For now use the same state representation for PEDESTRIAN. Later can add heading and etc. when it is calculated if desired
        },
